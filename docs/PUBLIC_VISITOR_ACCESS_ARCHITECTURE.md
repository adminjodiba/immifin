...
**Current Production / source:** `/pricing` is middleware-public (HTTP 200), in the About menu, and in the sitemap. S7-PUBLIC-001 “absent from chrome” is no longer true.

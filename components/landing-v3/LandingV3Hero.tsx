...
/**
 * /landing-v3 Design System 2.0 working copy — starts identical to locked V2.
 * Do not modify /landing-v2 from here.
 */
  ...
  return (
    <section className="relative w-full max-w-none shrink-0 overflow-hidden">
      ...
      >
        ...
        <div className={`${landingV3ContainerClass} pointer-events-none absolute inset-0 z-10 flex items-center justify-center`}>
          <div className="pointer-events-auto flex min-w-0 w-full flex-col items-center py-2 text-center">
            <div className="landing-v3-hero-title-lane hero-ribbon-title-rail w-full">
              ...
              >
                <h1 className="hero-ribbon-title-float whitespace-nowrap text-[clamp(1.4rem,2.9vw,2.25rem)] font-extrabold leading-[1.08] tracking-tight text-[var(--immifin-ds2-text-primary)] drop-shadow-[0_1px_0_rgba(255,255,255,0.55)]">

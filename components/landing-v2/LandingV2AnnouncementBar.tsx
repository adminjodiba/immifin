...
/** LOCKED /landing-v2 announcement bar — approved V7 chrome. Do not modify. */
export function LandingV2AnnouncementBar() {
  ...
  return (
    <div className="relative bg-[#0B1B3A] text-white">
      {/*
      ...
      */}
      <div
        className={`${landingV2ContainerClass} relative flex flex-col items-center gap-1.5 py-1.5 sm:flex-row sm:items-center sm:gap-0 sm:py-2`}
      >

...
const IMMIGRATION_IMAGE = "/images/immifin-immigration-approved.png";
const FINANCE_IMAGE = "/images/immifin-finance-approved.png";
const APPROVED_PANEL_WIDTH = 658;
const APPROVED_PANEL_HEIGHT = 797;
...
/**
 * LOCKED /landing-v2 — Immigration / Finance / Life product windows.
 * Approved V7 spacing. Do not modify.
 */
export function LandingV2ProductShowcase() {
  return (
    <section aria-label="Immigration, Finance, and Life" className="landing-v3-product-windows border-b border-slate-200/80">
      <div className={`${landingV2ContainerClass} pt-3 pb-10 sm:pt-3 sm:pb-12 lg:pt-4 lg:pb-14`}>

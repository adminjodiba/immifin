...
import { ExploreCapabilityCard } from "@/components/landing-v2/ExploreCapabilityCard";
...
type LandingV2ExploreProps = {
  /** Defaults to production/V2 wording; Landing V5 passes a PO-approved title. */
  title?: string;
};

export function LandingV2Explore({ title = "Tools For Immigration" }: LandingV2ExploreProps) {
  return (
